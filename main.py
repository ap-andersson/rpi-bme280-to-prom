...
def collect():
    """
    This is the function that contains the logic you want to run
    at each interval.
    """
    # Use flush=True to ensure logs are immediately visible in `docker logs`
    ...
    print(f"Data collected and set. Humidity: {humidity}%. Temperature: {temperature}C. Pressure: {pressure}hPa. Cpu: {cpu}C", flush=True)
